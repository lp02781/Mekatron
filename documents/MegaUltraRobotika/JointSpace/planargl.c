...
//		}
//		gerak1=0;        
		printf("%.4f %.4f %.4f %d \n",q1*RTD-100, q2*RTD,q3*RTD, gerak1);
...
void keyboard(unsigned char key, int i, int j)
{
	 ...
	 /* Joint Control */
		...
		case 'Q': dq1 += -20*DTR, gerak=1; break;
		case 'w': dq2 += 20*DTR, dq3+= -20*DTR, gerak=1; gerak1=1; break;
		case 'W': dq2 += -20*DTR, dq3+= 20*DTR, gerak=1; gerak1=2; break;
		case 'e': dq3 += 20*DTR, gerak=1; gerak1=3; break;
		case 'E': dq3 += -20*DTR, gerak=1; gerak1=3; break;
	//Kamera	
